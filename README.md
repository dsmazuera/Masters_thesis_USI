...
Through a qualitative analysis, the strategies used by each country in their fight against corruption were (i) categorized, (ii) classified according to their approach, and (iii) evaluated to determine which approach was most effective in reducing corruption levels.
...
In conclusion, the study highlights the need for a comprehensive approach, which not only opts for strategies that prevent corruption, but also has the capacity to detect and combat it. To achieve this, a solid legal framework, political stability and active participation of civil society are needed.
